"""Integration tests for TrainingModule with new features.
...
class TestTrainingModuleBlurOutMask:
    """Test TrainingModule with blur_out_mask feature."""

    def test_blur_out_mask_initialization(self) -> None:
        """Test that blur_out_mask flag is stored correctly."""
        module = TrainingModule(blur_out_mask=True)
        assert module.blur_out_mask_enabled is True

        module_disabled = TrainingModule(blur_out_mask=False)
...
class TestTrainingModuleTrueFacePower:
    """Test TrainingModule with true_face_power (CodeDiscriminator)."""

    def test_code_discriminator_initialization(self) -> None:
        """Test that CodeDiscriminator is created when true_face_power > 0."""
        module = TrainingModule(true_face_power=0.1)
    ...
    def test_code_discriminator_disabled_by_default(self) -> None:
        ...
        module = TrainingModule(true_face_power=0.0)
    ...
    def test_code_discriminator_forward(self) -> None:
        ...
        module = TrainingModule(true_face_power=0.1, encoder_dims=[64, 128, 256, 512])
        assert module.code_discriminator is not None
...
class TestTrainingModuleStyleLosses:
    """Test TrainingModule with style losses."""

    def test_face_style_weight_stored(self) -> None:
        """Test that face_style_weight is stored correctly."""
        module = TrainingModule(face_style_weight=0.1)
    ...
    def test_bg_style_weight_stored(self) -> None:
        ...
        module = TrainingModule(bg_style_weight=0.1)
    ...
    def test_compute_loss_with_mask(self) -> None:
        ...
        module = TrainingModule(face_style_weight=0.1, bg_style_weight=0.1)
...
class TestTrainingModuleConfigureOptimizers:
    ...
    def test_gan_two_optimizers(self) -> None:
        ...
        module = TrainingModule(gan_power=0.1)
        result = module.configure_optimizers()
    ...
    def test_gan_plus_true_face_three_optimizers(self) -> None:
        ...
        module = TrainingModule(gan_power=0.1, true_face_power=0.1)
        result = module.configure_optimizers()
...
class TestTrainingModuleForwardPass:
    """Test TrainingModule forward pass with new features."""
...
class TestTrainingModuleCombinedFeatures:
    """Test TrainingModule with multiple features enabled."""
...
class TestTrainingModuleHyperparameters:
