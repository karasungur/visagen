...
TRANSLATIONS = {
    ...
    "faceset_browser": {
        ...
        "status_loaded": "Loaded {count} faces",
        "status_selected": "Selected: {count}",
        "status_load_errors": "Load errors on page: {count}",
        "no_selected_files": "No selected files",
        "selection_cleared": "Selection cleared",
        "trash_summary": "Batch {batch_id}: moved {moved}, missing {missing}, failed {failed}",
        "undo_summary": "Undo {batch_id}: restored {restored}, skipped {skipped}, failed {failed}",
        "no_trash_batch": "No trash batch to undo",
    },
    # Settings tab
    "settings": {
        "title": "Settings",
    ...
    "sort": {
        ...
        "method": {
            ...
            "choices": {
                ...
                "ssim-dissim": "SSIM Dissimilarity",
        ...
        "jobs": {
            ...
            "info": "0 = auto (CPU count), otherwise fixed worker count",
        },
        "target_count": {
            "label": "Target Count",
